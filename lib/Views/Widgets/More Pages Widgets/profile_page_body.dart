    ...
    return Obx(
      () {
        String joinedDate = DateHelpers.formatDate(
          controller.userData.value!.user!.createdAt.toString(),
        );
        String workPlace = controller.userData.value!.user!.workingAt == null
            ? "Not setted yet."
            : controller.userData.value!.user!.workingAt.toString();
        String education = controller.userData.value!.user!.studiedAt == null
            ? "Not setted yet."
            : controller.userData.value!.user!.studiedAt.toString();
        String livesAt = controller.userData.value!.user!.address == null
            ? "Not setted yet."
            : controller.userData.value!.user!.address.toString();
        String relationShip =
            controller.userData.value!.user!.relationship == null
                ? "Not setted yet."
                : controller.userData.value!.user!.relationship.toString();
        return ClipRRect(
