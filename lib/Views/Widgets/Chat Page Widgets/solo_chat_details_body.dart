...
class SoloChatDetailsBody extends StatefulWidget {
  const SoloChatDetailsBody({super.key});

  @override
  State<SoloChatDetailsBody> createState() => _SoloChatDetailsBodyState();
}

class _SoloChatDetailsBodyState extends State<SoloChatDetailsBody> {
